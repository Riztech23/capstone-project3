...
# Initialize HuggingFace embeddings (FREE, local, 384 dimensions)
...
try:
    df = pd.read_csv("D:\Capstone Project Module 3\Capstone Project Module 3\data\imdb_top_1000.csv")
...
try:
    ...
    try:
        ...
        print(f"  - Vector Dimension: 384 (HuggingFace all-MiniLM-L6-v2)")
